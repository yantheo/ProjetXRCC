...
//spec_const bool sc_RayTracingShadowsHasSwappedViews 117 0
...
//spec_const bool sc_TAAEnabled 121 0
//spec_const bool sc_VertexBlendingUseNormals 122 0
//spec_const bool sc_VertexBlending 123 0
//spec_const bool sc_Voxelization 124 0
//spec_const bool uv2EnableAnimation 125 0
//spec_const bool uv3EnableAnimation 126 0
//spec_const int NODE_13_DROPLIST_ITEM 127 0
//spec_const int NODE_181_DROPLIST_ITEM 128 0
//spec_const int NODE_184_DROPLIST_ITEM 129 0
//spec_const int NODE_221_DROPLIST_ITEM 130 0
//spec_const int NODE_228_DROPLIST_ITEM 131 0
//spec_const int NODE_27_DROPLIST_ITEM 132 0
//spec_const int NODE_315_DROPLIST_ITEM 133 0
//spec_const int NODE_38_DROPLIST_ITEM 134 0
//spec_const int NODE_49_DROPLIST_ITEM 135 0
//spec_const int NODE_69_DROPLIST_ITEM 136 0
//spec_const int NODE_76_DROPLIST_ITEM 137 0
//spec_const int SC_DEVICE_CLASS 138 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 139 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_detailNormalTex 140 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_emissiveTex 141 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 142 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_materialParamsTex 143 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 144 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 145 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex 146 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_reflectionTex 147 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_rimColorTex 148 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 149 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_detailNormalTex 150 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_emissiveTex 151 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 152 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_materialParamsTex 153 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 154 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 155 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex 156 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_reflectionTex 157 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_rimColorTex 158 -1
//spec_const int baseTexLayout 159 0
//spec_const int detailNormalTexLayout 160 0
//spec_const int emissiveTexLayout 161 0
//spec_const int intensityTextureLayout 162 0
//spec_const int materialParamsTexLayout 163 0
//spec_const int normalTexLayout 164 0
//spec_const int opacityTexLayout 165 0
//spec_const int reflectionModulationTexLayout 166 0
//spec_const int reflectionTexLayout 167 0
//spec_const int rimColorTexLayout 168 0
//spec_const int sc_AmbientLightMode0 169 0
//spec_const int sc_AmbientLightMode1 170 0
//spec_const int sc_AmbientLightMode2 171 0
//spec_const int sc_AmbientLightMode_Constant 172 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 173 0
//spec_const int sc_AmbientLightMode_FromCamera 174 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 175 0
//spec_const int sc_AmbientLightsCount 176 0
//spec_const int sc_DepthBufferMode 177 0
//spec_const int sc_DirectionalLightsCount 178 0
//spec_const int sc_EnvLightMode 179 0
//spec_const int sc_EnvmapDiffuseLayout 180 0
//spec_const int sc_EnvmapSpecularLayout 181 0
//spec_const int sc_LightEstimationSGCount 182 0
//spec_const int sc_PointLightsCount 183 0
//spec_const int sc_RayTracingGlobalIlluminationLayout 184 0
//spec_const int sc_RayTracingShadowsLayout 185 0
...
constant bool sc_RayTracingShadowsHasSwappedViews [[function_constant(117)]];
...
constant bool sc_TAAEnabled [[function_constant(121)]];
constant bool sc_TAAEnabled_tmp = is_function_constant_defined(sc_TAAEnabled) ? sc_TAAEnabled : false;
constant bool sc_VertexBlendingUseNormals [[function_constant(122)]];
constant bool sc_VertexBlendingUseNormals_tmp = is_function_constant_defined(sc_VertexBlendingUseNormals) ? sc_VertexBlendingUseNormals : false;
constant bool sc_VertexBlending [[function_constant(123)]];
constant bool sc_VertexBlending_tmp = is_function_constant_defined(sc_VertexBlending) ? sc_VertexBlending : false;
constant bool sc_Voxelization [[function_constant(124)]];
...
constant int sc_PointLightsCount [[function_constant(183)]];
constant int sc_PointLightsCount_tmp = is_function_constant_defined(sc_PointLightsCount) ? sc_PointLightsCount : 0;
constant int sc_RayTracingGlobalIlluminationLayout [[function_constant(184)]];
...
constant int sc_RayTracingShadowsLayout [[function_constant(185)]];
...
constant int sc_RenderingSpace [[function_constant(186)]];
constant int sc_RenderingSpace_tmp = is_function_constant_defined(sc_RenderingSpace) ? sc_RenderingSpace : -1;
constant int sc_ScreenTextureLayout [[function_constant(187)]];
constant int sc_ScreenTextureLayout_tmp = is_function_constant_defined(sc_ScreenTextureLayout) ? sc_ScreenTextureLayout : 0;
constant int sc_ShaderCacheConstant [[function_constant(188)]];
constant int sc_ShaderCacheConstant_tmp = is_function_constant_defined(sc_ShaderCacheConstant) ? sc_ShaderCacheConstant : 0;
constant int sc_SkinBonesCount [[function_constant(189)]];
constant int sc_SkinBonesCount_tmp = is_function_constant_defined(sc_SkinBonesCount) ? sc_SkinBonesCount : 0;
constant int sc_StereoRenderingMode [[function_constant(190)]];
constant int sc_StereoRenderingMode_tmp = is_function_constant_defined(sc_StereoRenderingMode) ? sc_StereoRenderingMode : 0;
constant int sc_StereoRendering_IsClipDistanceEnabled [[function_constant(191)]];
...
ssGlobals tempGlobals=param_34;
...
float3 param_35=Albedo_N7.xyz;
float param_36=Opacity_N7;
float3 param_37=Normal_N7;
float3 param_38=Emissive_N7;
float3 param_39=AO_N7;
ssGlobals param_41=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_41.BumpedNormal=param_37;
}
param_36=fast::clamp(param_36,0.0,1.0);
float l9_973=param_36;
...
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_40=float4(param_35,param_36);
}
else
{
param_38=fast::max(param_38,float3(0.0));
float l9_977=0.0;
float l9_978=1.0;
param_39=fast::clamp(param_39,float3(0.0),float3(1.0));
float3 l9_979=float3(1.0);
float3 l9_980=param_35;
float l9_981=param_36;
float3 l9_982=param_41.BumpedNormal;
float3 l9_983=param_41.PositionWS;
float3 l9_984=param_41.ViewDirWS;
float3 l9_985=param_38;
float l9_986=l9_977;
float l9_987=l9_978;
float3 l9_988=param_39;
float3 l9_989=l9_979;
param_40=ngsCalculateLighting(l9_980,l9_981,l9_982,l9_983,l9_984,l9_985,l9_986,l9_987,l9_988,l9_989,in.varStereoViewID,sc_set0.sc_EnvmapDiffuse,sc_set0.sc_EnvmapDiffuseSmpSC,sc_set0.sc_EnvmapSpecular,sc_set0.sc_EnvmapSpecularSmpSC,sc_set0.sc_ScreenTexture,sc_set0.sc_ScreenTextureSmpSC,sc_set0.sc_RayTracingGlobalIllumination,sc_set0.sc_RayTracingGlobalIlluminationSmpSC,sc_set0.sc_RayTracingShadows,sc_set0.sc_RayTracingShadowsSmpSC,gl_FragCoord,(*sc_set0.UserUniforms),in.varShadowTex,sc_set0.sc_ShadowTexture,sc_set0.sc_ShadowTextureSmpSC,out.sc_FragData0,sc_set0.sc_SSAOTexture,sc_set0.sc_SSAOTextureSmpSC);
}
...
float4 l9_990=fast::max(param_42,float4(0.0));
float4 param_43=l9_990;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_993=fast::clamp(l9_992.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_993=fast::clamp(dot(l9_992.xyz,float3(l9_992.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_993=(1.0-dot(l9_992.xyz,float3(0.33333001)))*l9_992.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_993=(1.0-fast::clamp(dot(l9_992.xyz,float3(1.0)),0.0,1.0))*l9_992.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_993=fast::clamp(dot(l9_992.xyz,float3(1.0)),0.0,1.0)*l9_992.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_993=fast::clamp(dot(l9_992.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_993=dot(l9_992.xyz,float3(0.33333001))*l9_992.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_993=1.0-fast::clamp(dot(l9_992.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_994=l9_993;
float l9_995=l9_994;
float l9_996=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_995;
float3 l9_997=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_991.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_998=float4(l9_997.x,l9_997.y,l9_997.z,l9_996);
param_44=l9_998;
}
else
{
...
{
float4 l9_999=param_44;
float4 l9_1000=float4(0.0);
float4 l9_1001=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_1002=out.sc_FragData0;
l9_1001=l9_1002;
}
else
{
float4 l9_1003=gl_FragCoord;
float2 l9_1004=l9_1003.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
{
l9_1008=in.varStereoViewID;
}
int l9_1009=l9_1008;
int l9_1010=l9_1009;
float3 l9_1011=float3(l9_1005,0.0);
int l9_1012=l9_1007;
int l9_1013=l9_1010;
if (l9_1012==1)
{
l9_1011.y=((2.0*l9_1011.y)+float(l9_1013))-1.0;
}
float2 l9_1014=l9_1011.xy;
l9_1006=l9_1014;
}
else
{
...
float2 l9_1015=l9_1006;
float2 l9_1016=l9_1015;
float2 l9_1017=l9_1016;
float2 l9_1018=l9_1017;
float l9_1019=0.0;
int l9_1020;
if ((int(sc_ScreenTextureHasSwappedViews_tmp)!=0))
{
...
int l9_1025=l9_1020;
float2 l9_1026=l9_1018;
int l9_1027=sc_ScreenTextureLayout_tmp;
int l9_1028=l9_1025;
float l9_1029=l9_1019;
...
float4 l9_1036=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_1035.xy,bias(l9_1029));
float4 l9_1037=l9_1036;
float4 l9_1038=l9_1037;
l9_1001=l9_1038;
}
float4 l9_1039=l9_1001;
float3 l9_1040=l9_1039.xyz;
float3 l9_1041=l9_1040;
float3 l9_1042=l9_999.xyz;
float3 l9_1043=definedBlend(l9_1041,l9_1042,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_1000=float4(l9_1043.x,l9_1043.y,l9_1043.z,l9_1000.w);
float3 l9_1044=mix(l9_1040,l9_1000.xyz,float3(l9_999.w));
l9_1000=float4(l9_1044.x,l9_1044.y,l9_1044.z,l9_1000.w);
l9_1000.w=1.0;
float4 l9_1045=l9_1000;
param_44=l9_1045;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_1046=float4(in.varScreenPos.xyz,1.0);
param_44=l9_1046;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_1047=gl_FragCoord;
float l9_1048=fast::clamp(abs(l9_1047.z),0.0,1.0);
float4 l9_1049=float4(l9_1048,1.0-l9_1048,1.0,1.0);
param_44=l9_1049;
}
else
{
float4 l9_1050=param_44;
float4 l9_1051=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_1051=float4(mix(float3(1.0),l9_1050.xyz,float3(l9_1050.w)),l9_1050.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_1052=l9_1050.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_1052=fast::clamp(l9_1052,0.0,1.0);
}
l9_1051=float4(l9_1050.xyz*l9_1052,l9_1052);
}
else
{
l9_1051=l9_1050;
...
float4 l9_1057=param_46;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_1057.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_1057;
return out;
}
} // FRAGMENT SHADER
