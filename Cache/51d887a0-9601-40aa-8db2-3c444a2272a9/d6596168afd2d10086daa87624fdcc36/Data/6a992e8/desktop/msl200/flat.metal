...
{
float4 l9_629=out.sc_FragData0;
l9_628=l9_629;
}
else
{
...
int l9_652=l9_647;
float2 l9_653=l9_645;
int l9_654=sc_ScreenTextureLayout_tmp;
int l9_655=l9_652;
float l9_656=l9_646;
...
float4 l9_663=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_662.xy,bias(l9_656));
float4 l9_664=l9_663;
float4 l9_665=l9_664;
l9_628=l9_665;
}
float4 l9_666=l9_628;
float3 l9_667=l9_666.xyz;
float3 l9_668=l9_667;
float3 l9_669=l9_626.xyz;
float3 l9_670=definedBlend(l9_668,l9_669,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_627=float4(l9_670.x,l9_670.y,l9_670.z,l9_627.w);
float3 l9_671=mix(l9_667,l9_627.xyz,float3(l9_626.w));
l9_627=float4(l9_671.x,l9_671.y,l9_671.z,l9_627.w);
l9_627.w=1.0;
float4 l9_672=l9_627;
param_13=l9_672;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_673=float4(in.varScreenPos.xyz,1.0);
param_13=l9_673;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_674=gl_FragCoord;
float l9_675=fast::clamp(abs(l9_674.z),0.0,1.0);
float4 l9_676=float4(l9_675,1.0-l9_675,1.0,1.0);
param_13=l9_676;
}
else
{
...
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_678=float4(mix(float3(1.0),l9_677.xyz,float3(l9_677.w)),l9_677.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_679=l9_677.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_679=fast::clamp(l9_679,0.0,1.0);
}
l9_678=float4(l9_677.xyz*l9_679,l9_679);
}
else
{
l9_678=l9_677;
...
float4 l9_684=param_15;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_684.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_684;
return out;
}
} // FRAGMENT SHADER
