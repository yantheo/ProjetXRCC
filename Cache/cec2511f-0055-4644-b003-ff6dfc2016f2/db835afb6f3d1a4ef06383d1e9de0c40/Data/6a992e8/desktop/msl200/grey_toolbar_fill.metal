...
//float4 Port_Input1_N001 4656
//float4 Port_Input1_N008 4672
//float depthRef 4688
//}
...
constant bool NOMASK [[function_constant(31)]];
constant bool NOMASK_tmp = is_function_constant_defined(NOMASK) ? NOMASK : false;
constant bool NOTEXTURE [[function_constant(32)]];
constant bool NOTEXTURE_tmp = is_function_constant_defined(NOTEXTURE) ? NOTEXTURE : false;
...
float4 param_2=(*sc_set0.UserUniforms).Port_Input1_N001;
float4 param_3=float4(0.0);
ssGlobals param_5=Globals;
float4 param_4;
if ((int(NOTEXTURE_tmp)!=0))
{
param_4=param_2;
}
else
...
int l9_7=l9_2;
int l9_8=baseTexLayout_tmp;
int l9_9=l9_7;
float2 l9_10=param_5.Surface_UVCoord0;
bool l9_11=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_12=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_13=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_14=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_15=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_16=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_17=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_18=0.0;
bool l9_19=l9_16&&(!l9_14);
float l9_20=1.0;
float l9_21=l9_10.x;
int l9_22=l9_13.x;
if (l9_22==1)
...
if (l9_22==2)
{
float l9_23=fract(l9_21);
float l9_24=l9_21-l9_23;
float l9_25=step(0.25,fract(l9_24*0.5));
l9_21=mix(l9_23,1.0-l9_23,fast::clamp(l9_25,0.0,1.0));
}
}
l9_10.x=l9_21;
float l9_26=l9_10.y;
...
bool l9_45=l9_41;
float l9_46=l9_20;
float l9_47=fast::clamp(l9_42,l9_43,l9_44);
float l9_48=step(abs(l9_42-l9_47),9.9999997e-06);
l9_46*=(l9_48+((1.0-float(l9_45))*(1.0-l9_48)));
l9_42=l9_47;
l9_10.y=l9_42;
l9_20=l9_46;
}
float2 l9_49=l9_10;
bool l9_50=l9_11;
float3x3 l9_51=l9_12;
if (l9_50)
{
l9_49=float2((l9_51*float3(l9_49,1.0)).xy);
}
float2 l9_52=l9_49;
l9_10=l9_52;
float l9_53=l9_10.x;
...
float3 l9_83=l9_82;
float3 l9_84=l9_83;
float4 l9_85=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_84.xy,bias(l9_78));
float4 l9_86=l9_85;
if (l9_16)
{
l9_86=mix(l9_17,l9_86,float4(l9_20));
}
float4 l9_87=l9_86;
l9_1=l9_87;
param_3=l9_1;
...
float4 param_6=(*sc_set0.UserUniforms).Port_Input1_N008;
...
int l9_94=l9_89;
int l9_95=opacityTexLayout_tmp;
int l9_96=l9_94;
float2 l9_97=param_9.Surface_UVCoord0;
bool l9_98=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_99=(*sc_set0.UserUniforms).opacityTexTransform;
int2 l9_100=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_101=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_102=(*sc_set0.UserUniforms).opacityTexUvMinMax;
bool l9_103=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_104=(*sc_set0.UserUniforms).opacityTexBorderColor;
float l9_105=0.0;
bool l9_106=l9_103&&(!l9_101);
float l9_107=1.0;
float l9_108=l9_97.x;
int l9_109=l9_100.x;
if (l9_109==1)
{
l9_108=fract(l9_108);
...
if (l9_114==2)
{
float l9_115=fract(l9_113);
float l9_116=l9_113-l9_115;
float l9_117=step(0.25,fract(l9_116*0.5));
l9_113=mix(l9_115,1.0-l9_115,fast::clamp(l9_117,0.0,1.0));
}
}
l9_97.y=l9_113;
if (l9_101)
...
float l9_120=l9_97.x;
float l9_121=l9_102.x;
float l9_122=l9_102.z;
bool l9_123=l9_119;
float l9_124=l9_107;
...
float l9_129=l9_97.y;
float l9_130=l9_102.y;
float l9_131=l9_102.w;
bool l9_132=l9_128;
float l9_133=l9_107;
...
float2 l9_136=l9_97;
bool l9_137=l9_98;
float3x3 l9_138=l9_99;
if (l9_137)
{
l9_136=float2((l9_138*float3(l9_136,1.0)).xy);
}
float2 l9_139=l9_136;
l9_97=l9_139;
float l9_140=l9_97.x;
int l9_141=l9_100.x;
bool l9_142=l9_106;
float l9_143=l9_107;
...
float4 l9_172=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_171.xy,bias(l9_165));
float4 l9_173=l9_172;
if (l9_103)
{
l9_173=mix(l9_104,l9_173,float4(l9_107));
}
...
Output_N8=param_8;
float Output_N9=0.0;
Output_N9=Output_N8.x;
float4 Value_N10=float4(0.0);
Value_N10=float4(Output_N1.xyz.x,Output_N1.xyz.y,Output_N1.xyz.z,Value_N10.w);
Value_N10.w=Output_N9;
float4 Output_N7=float4(0.0);
Output_N7=Output_N6*Value_N10;
...
{
float4 l9_175=gl_FragCoord;
float2 l9_176=floor(mod(l9_175.xy,float2(4.0)));
float l9_177=(mod(dot(l9_176,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_10<l9_177)
{
discard_fragment();
}
...
{
l9_181=fast::clamp(l9_180.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_181=fast::clamp(dot(l9_180.xyz,float3(l9_180.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_181=(1.0-dot(l9_180.xyz,float3(0.33333001)))*l9_180.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_181=(1.0-fast::clamp(dot(l9_180.xyz,float3(1.0)),0.0,1.0))*l9_180.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_181=fast::clamp(dot(l9_180.xyz,float3(1.0)),0.0,1.0)*l9_180.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_181=fast::clamp(dot(l9_180.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_181=dot(l9_180.xyz,float3(0.33333001))*l9_180.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_181=1.0-fast::clamp(dot(l9_180.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_182=l9_181;
float l9_183=l9_182;
float l9_184=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_183;
float3 l9_185=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_179.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_186=float4(l9_185.x,l9_185.y,l9_185.z,l9_184);
param_13=l9_186;
}
else
{
...
{
float4 l9_187=param_13;
float4 l9_188=float4(0.0);
float4 l9_189=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_190=out.sc_FragData0;
l9_189=l9_190;
}
else
{
float4 l9_191=gl_FragCoord;
float2 l9_192=l9_191.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_193=l9_192;
...
int l9_197=l9_196;
int l9_198=l9_197;
float3 l9_199=float3(l9_193,0.0);
int l9_200=l9_195;
int l9_201=l9_198;
if (l9_200==1)
{
l9_199.y=((2.0*l9_199.y)+float(l9_201))-1.0;
}
float2 l9_202=l9_199.xy;
l9_194=l9_202;
}
else
{
...
int l9_213=l9_208;
float2 l9_214=l9_206;
int l9_215=sc_ScreenTextureLayout_tmp;
int l9_216=l9_213;
float l9_217=l9_207;
...
float4 l9_224=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_223.xy,bias(l9_217));
float4 l9_225=l9_224;
float4 l9_226=l9_225;
l9_189=l9_226;
}
float4 l9_227=l9_189;
float3 l9_228=l9_227.xyz;
float3 l9_229=l9_228;
float3 l9_230=l9_187.xyz;
float3 l9_231=definedBlend(l9_229,l9_230,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_188=float4(l9_231.x,l9_231.y,l9_231.z,l9_188.w);
float3 l9_232=mix(l9_228,l9_188.xyz,float3(l9_187.w));
l9_188=float4(l9_232.x,l9_232.y,l9_232.z,l9_188.w);
l9_188.w=1.0;
float4 l9_233=l9_188;
param_13=l9_233;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_234=float4(in.varScreenPos.xyz,1.0);
param_13=l9_234;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_235=gl_FragCoord;
float l9_236=fast::clamp(abs(l9_235.z),0.0,1.0);
float4 l9_237=float4(l9_236,1.0-l9_236,1.0,1.0);
param_13=l9_237;
}
else
{
float4 l9_238=param_13;
float4 l9_239=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_239=float4(mix(float3(1.0),l9_238.xyz,float3(l9_238.w)),l9_238.w);
}
else
{
...
{
l9_240=fast::clamp(l9_240,0.0,1.0);
}
l9_239=float4(l9_238.xyz*l9_240,l9_240);
}
else
{
l9_239=l9_238;
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_14,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_15=FinalColor;
float4 l9_245=param_15;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_245.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_245;
return out;
}
} // FRAGMENT SHADER
