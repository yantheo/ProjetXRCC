...
uniform float Port_Value1_N022;
uniform float Port_Default_N022;
...
#endif
vec4 l9_0=sc_SampleTextureBiasOrLevel(Tweak_N2Dims.xy,Tweak_N2Layout,Tweak_N2GetStereoViewIndex(),varPackedTex.xy*vec2(scale),(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2),(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0),Tweak_N2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0),Tweak_N2BorderColor,0.0,Tweak_N2);
vec4 l9_1=sc_SampleTextureBiasOrLevel(Tweak_N2Dims.xy,Tweak_N2Layout,Tweak_N2GetStereoViewIndex(),varPackedTex.xy*vec2(Tweak_N7),(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2),(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0),Tweak_N2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0),Tweak_N2BorderColor,0.0,Tweak_N2);
vec4 l9_2=mix(backgroundColor,gridColor,vec4(max(l9_0.x,l9_1.x)));
float l9_3;
...
{
l9_8=clamp(dot(l9_2.xyz,vec3(l9_4)),0.0,1.0);
}
#else
{
float l9_9;
...
{
l9_10=(1.0-dot(l9_2.xyz,vec3(0.33333001)))*l9_4;
}
#else
{
float l9_11;
...
{
l9_11=(1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0))*l9_4;
}
#else
{
float l9_12;
...
{
l9_12=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*l9_4;
}
#else
{
float l9_13;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_14=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*l9_4;
}
#else
{
float l9_15;
...
{
l9_15=dot(l9_2.xyz,vec3(0.33333001))*l9_4;
}
#else
{
float l9_16;
...
#endif
vec3 l9_28=mix(l9_26.xyz,definedBlend(l9_26.xyz,l9_2.xyz).xyz,vec3(l9_4));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_30=vec4(mix(vec3(1.0),l9_2.xyz,vec3(l9_4)),l9_4);
}
#else
{
vec4 l9_31;
...
#endif
l9_31=vec4(l9_2.xyz*l9_32,l9_32);
}
#else
{
l9_31=l9_2;
