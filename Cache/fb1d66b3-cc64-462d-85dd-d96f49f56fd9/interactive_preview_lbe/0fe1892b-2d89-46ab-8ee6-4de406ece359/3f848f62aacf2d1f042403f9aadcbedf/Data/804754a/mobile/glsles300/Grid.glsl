...
//sampler sampler Tweak_N2SmpSC 2:16
...
//texture texture2D Tweak_N2 2:0:2:16
...
//texture texture2DArray Tweak_N2ArrSC 2:25:2:16
...
uniform vec4 Tweak_N2Size;
uniform vec4 Tweak_N2View;
uniform mat3 Tweak_N2Transform;
uniform vec4 Tweak_N2UvMinMax;
uniform vec4 Tweak_N2BorderColor;
uniform float scale;
uniform float Tweak_N7;
...
#endif
#ifndef Tweak_N2HasSwappedViews
#define Tweak_N2HasSwappedViews 0
#elif Tweak_N2HasSwappedViews==1
#undef Tweak_N2HasSwappedViews
#define Tweak_N2HasSwappedViews 1
#endif
#ifndef Tweak_N2Layout
#define Tweak_N2Layout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_Tweak_N2
#define SC_USE_UV_TRANSFORM_Tweak_N2 0
#elif SC_USE_UV_TRANSFORM_Tweak_N2==1
#undef SC_USE_UV_TRANSFORM_Tweak_N2
#define SC_USE_UV_TRANSFORM_Tweak_N2 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N2
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N2 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N2
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N2 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N2
#define SC_USE_UV_MIN_MAX_Tweak_N2 0
#elif SC_USE_UV_MIN_MAX_Tweak_N2==1
#undef SC_USE_UV_MIN_MAX_Tweak_N2
#define SC_USE_UV_MIN_MAX_Tweak_N2 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N2
#define SC_USE_CLAMP_TO_BORDER_Tweak_N2 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N2==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N2
#define SC_USE_CLAMP_TO_BORDER_Tweak_N2 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
uniform vec4 Tweak_N2Size;
uniform vec4 Tweak_N2View;
uniform mediump sampler2D Tweak_N2;
uniform mediump sampler2DArray Tweak_N2ArrSC;
...
int Tweak_N2GetStereoViewIndex()
{
int l9_0;
#if (Tweak_N2HasSwappedViews)
{
...
#endif
vec2 l9_0=varPackedTex.xy*vec2(scale);
vec4 l9_1;
#if (Tweak_N2Layout==2)
{
l9_1=sc_SampleTextureBiasOrLevel(Tweak_N2Dims.xy,Tweak_N2Layout,Tweak_N2GetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2),(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0),Tweak_N2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0),Tweak_N2BorderColor,0.0,Tweak_N2ArrSC);
}
#else
{
l9_1=sc_SampleTextureBiasOrLevel(Tweak_N2Dims.xy,Tweak_N2Layout,Tweak_N2GetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2),(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0),Tweak_N2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0),Tweak_N2BorderColor,0.0,Tweak_N2);
...
#endif
vec2 l9_2=varPackedTex.xy*vec2(Tweak_N7);
vec4 l9_3;
#if (Tweak_N2Layout==2)
{
l9_3=sc_SampleTextureBiasOrLevel(Tweak_N2Dims.xy,Tweak_N2Layout,Tweak_N2GetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2),(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0),Tweak_N2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0),Tweak_N2BorderColor,0.0,Tweak_N2ArrSC);
}
#else
{
l9_3=sc_SampleTextureBiasOrLevel(Tweak_N2Dims.xy,Tweak_N2Layout,Tweak_N2GetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2),(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0),Tweak_N2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0),Tweak_N2BorderColor,0.0,Tweak_N2);
...
#endif
vec4 l9_4=mix(backgroundColor,gridColor,vec4(max(l9_1.x,l9_3.x)));
float l9_5;
if ((float(gl_FrontFacing)*1.0)!=0.0)
{
l9_5=-1.0;
}
else
...
{
l9_10=clamp(dot(l9_4.xyz,vec3(l9_6)),0.0,1.0);
}
#else
{
float l9_11;
...
{
l9_12=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*l9_6;
}
#else
{
float l9_13;
...
{
l9_13=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*l9_6;
}
#else
{
float l9_14;
...
{
l9_14=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_6;
}
#else
{
float l9_15;
#if (sc_BlendMode_Add)
{
l9_15=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_16;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_16=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_6;
}
#else
{
float l9_17;
...
{
l9_17=dot(l9_4.xyz,vec3(0.33333001))*l9_6;
}
#else
{
float l9_18;
#if (sc_BlendMode_Min)
{
l9_18=1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_19;
...
#endif
l9_7=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_4.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_8);
}
#else
{
vec4 l9_20;
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_23=sc_readFragData0_Platform();
vec4 l9_24;
...
#endif
vec3 l9_31=mix(l9_29.xyz,definedBlend(l9_29.xyz,l9_4.xyz).xyz,vec3(l9_6));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_33=vec4(mix(vec3(1.0),l9_4.xyz,vec3(l9_6)),l9_6);
}
#else
{
vec4 l9_34;
...
#endif
l9_34=vec4(l9_4.xyz*l9_35,l9_35);
}
#else
{
l9_34=l9_4;
...
#endif
vec4 l9_36=outputMotionVectorsIfNeeded(varPos,max(l9_7,vec4(0.0)));
...
mediump vec4 l9_78=texture(sc_OITFilteredDepthBoundsTexture,l9_52);
vec2 l9_79=l9_78.xy;
int l9_80;
#if (sc_SkinBonesCount>0)
{
