...
//texture texture2DArray baseColorTextureArrSC 2:45:2:26
//texture texture2DArray clearcoatNormalTextureArrSC 2:46:2:27
//texture texture2DArray clearcoatRoughnessTextureArrSC 2:47:2:28
//texture texture2DArray clearcoatTextureArrSC 2:48:2:29
//texture texture2DArray emissiveTextureArrSC 2:49:2:30
//texture texture2DArray intensityTextureArrSC 2:50:2:31
//texture texture2DArray metallicRoughnessTextureArrSC 2:51:2:32
//texture texture2DArray normalTextureArrSC 2:52:2:33
//texture texture2DArray sc_EnvmapDiffuseArrSC 2:53:2:34
//texture texture2DArray sc_EnvmapSpecularArrSC 2:54:2:35
//texture texture2DArray sc_ScreenTextureArrSC 2:55:2:38
//texture texture2DArray screenTextureArrSC 2:56:2:41
//texture texture2DArray sheenColorTextureArrSC 2:57:2:42
//texture texture2DArray sheenRoughnessTextureArrSC 2:58:2:43
//texture texture2DArray transmissionTextureArrSC 2:59:2:44
//SG_REFLECTION_END
...
{
vec4 l9_39=l9_31;
l9_39.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_31.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_31.w;
l9_38=l9_39;
}
else
{
...
{
float l9_40=dot(l9_37,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_40);
}
#else
{
varClipDistance=l9_40;
}
#endif
}
#endif
...
mediump vec4 sc_readFragData0()
{
mediump vec4 l9_0=sc_readFragData0_Platform();
vec4 l9_1;
...
tempGlobals=Globals;
N3_DebugSheenEnvLightMult=1.0;
N3_DebugSheenPunctualLightMult=1.0;
...
vec3 l9_53=N3_SheenOut.xyz+(((sampleSpecularEnvTextureLod(normalize(reflect(-l9_44,l9_30)),3.0+((((l9_42*4.0)-0.0)*2.0)/5.0))*sc_EnvmapExposure)*l9_34)*clamp((exp(l9_51)+l9_52)*3.1415927,0.0,1.0));
...
#else
{
l9_108=ngsCalculateLighting(l9_107,l9_106,l9_105,Globals.PositionWS,Globals.ViewDirWS,max(l9_97,vec3(0.0)),clamp(l9_98,0.0,1.0),clamp(l9_99,0.0,1.0),clamp(N3_Occlusion.xyz,vec3(0.0),vec3(1.0)),vec3(1.0));
}
#endif
...
#if (sc_ProjectiveShadowsCaster)
{
l9_111=vec4(0.0,0.0,0.0,1.0);
}
#else
{
l9_111=ngsCalculateLighting(vec3(0.0),1.0,l9_110,Globals.PositionWS,Globals.ViewDirWS,vec3(0.0),0.0,clamp(l9_104,0.0,1.0),vec3(1.0),vec3(1.0));
}
#endif
tempGlobals=Globals;
N31_PbrIn=l9_109;
...
{
l9_10=clamp(dot(l9_6.xyz,vec3(l9_6.w)),0.0,1.0);
}
#else
{
float l9_11;
...
#if (sc_BlendMode_Multiply)
{
l9_12=(1.0-dot(l9_6.xyz,vec3(0.33333001)))*l9_6.w;
}
#else
{
float l9_13;
...
{
l9_13=(1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0))*l9_6.w;
}
#else
{
float l9_14;
#if (sc_BlendMode_ColoredGlass)
{
l9_14=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_6.w;
}
#else
{
float l9_15;
#if (sc_BlendMode_Add)
{
l9_15=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_16;
...
{
l9_17=dot(l9_6.xyz,vec3(0.33333001))*l9_6.w;
}
#else
{
float l9_18;
#if (sc_BlendMode_Min)
{
l9_18=1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_19;
...
#endif
l9_7=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_6.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_8);
}
#else
{
vec4 l9_20;
...
{
vec3 l9_22=sc_GetFramebufferColor().xyz;
vec3 l9_23=mix(l9_22,definedBlend(l9_22,l9_6.xyz).xyz,vec3(l9_6.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_25=vec4(mix(vec3(1.0),l9_6.xyz,vec3(l9_6.w)),l9_6.w);
}
#else
{
vec4 l9_26;
...
#endif
l9_26=vec4(l9_6.xyz*l9_27,l9_27);
}
#else
{
l9_26=l9_6;
...
#endif
vec4 l9_28=outputMotionVectorsIfNeeded(varPos,max(l9_7,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_30-0.0039215689)),min(1.0,l9_30+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_31=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_31).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_32=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_31).xy);
float l9_33=packValue(l9_32);
int l9_40=int(l9_29.w*255.0);
float l9_41=packValue(l9_40);
sc_writeFragData0(vec4(packValue(l9_32),packValue(l9_32),packValue(l9_32),packValue(l9_32)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_44=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_49==0)
{
l9_52=texture(sc_OITAlpha0,l9_44);
l9_51=texture(sc_OITDepthLow0,l9_44);
l9_50=texture(sc_OITDepthHigh0,l9_44);
}
else
{
l9_52=vec4(0.0);
...
if (l9_49==1)
{
l9_55=texture(sc_OITAlpha1,l9_44);
l9_54=texture(sc_OITDepthLow1,l9_44);
l9_53=texture(sc_OITDepthHigh1,l9_44);
}
else
{
l9_55=l9_52;
...
mediump vec4 l9_70=texture(sc_OITFilteredDepthBoundsTexture,l9_44);
vec2 l9_71=l9_70.xy;
int l9_72;
#if (sc_SkinBonesCount>0)
{
...
#if (sc_OITFrontLayerPass)
{
if (abs(gl_FragCoord.z-texture(sc_OITFrontDepthTexture,sc_ScreenCoordsGlobalToView(l9_5)).x)>getFrontLayerZTestEpsilon())
{
discard;
}
