...
vec4 l9_3=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_2.x,l9_2.y),0.5);
...
#endif
vec4 l9_29=vec4(l9_27.x,l9_27.y,l9_27.z,vec4(0.0).w);
l9_29.w=1.0;
l9_20=l9_29;
}
#else
