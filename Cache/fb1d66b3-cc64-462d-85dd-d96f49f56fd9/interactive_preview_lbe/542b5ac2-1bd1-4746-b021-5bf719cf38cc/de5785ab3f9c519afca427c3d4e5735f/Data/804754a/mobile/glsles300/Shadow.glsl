...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_2=abs(varShadowTex-vec2(0.5));
vec4 l9_3=texture(sc_ShadowTexture,varShadowTex)*step(max(l9_2.x,l9_2.y),0.5);
l9_1=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),vec3(l9_3.w*sc_ShadowDensity));
}
#else
{
l9_1=vec3(1.0);
...
#endif
vec3 l9_4=l9_0*Tweak_N1.xyz;
vec4 l9_5=vec4(l9_4,0.0);
...
{
l9_11=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*0.0;
}
#else
{
float l9_12;
...
{
l9_12=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*0.0;
}
#else
{
float l9_13;
...
{
l9_13=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_14;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_15=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_16;
...
{
l9_16=dot(l9_5.xyz,vec3(0.33333001))*0.0;
}
#else
{
float l9_17;
...
#endif
vec4 l9_30=vec4(l9_28.x,l9_28.y,l9_28.z,vec4(0.0).w);
l9_30.w=1.0;
l9_20=l9_30;
}
#else
...
#endif
vec4 l9_33=outputMotionVectorsIfNeeded(varPos,max(l9_6,vec4(0.0)));
...
mediump vec4 l9_75=texture(sc_OITFilteredDepthBoundsTexture,l9_49);
vec2 l9_76=l9_75.xy;
int l9_77;
#if (sc_SkinBonesCount>0)
{
