...
#endif
l9_1=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_2,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
}
#else
{
l9_1=Port_Default_N369;
}
#endif
vec4 l9_3=baseColor*l9_1;
float l9_4=l9_3.w*Port_Default_N204;
...
{
l9_9=clamp(dot(l9_5.xyz,vec3(l9_4)),0.0,1.0);
}
#else
{
float l9_10;
...
{
l9_11=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_4;
}
#else
{
float l9_12;
...
{
l9_12=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_4;
}
#else
{
float l9_13;
...
{
l9_13=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_4;
}
#else
{
float l9_14;
...
{
l9_16=dot(l9_5.xyz,vec3(0.33333001))*l9_4;
}
#else
{
float l9_17;
...
#else
{
vec2 l9_25=sc_ScreenCoordsGlobalToView(l9_0);
int l9_26;
...
#endif
vec3 l9_29=mix(l9_27.xyz,definedBlend(l9_27.xyz,l9_5.xyz).xyz,vec3(l9_4));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_31=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_4)),l9_4);
}
#else
{
vec4 l9_32;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_41=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_41).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_42=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_41).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_54=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_54).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_59==0)
{
l9_62=texture2D(sc_OITAlpha0,l9_54);
l9_61=texture2D(sc_OITDepthLow0,l9_54);
l9_60=texture2D(sc_OITDepthHigh0,l9_54);
}
else
{
l9_62=vec4(0.0);
...
if (l9_59==1)
{
l9_65=texture2D(sc_OITAlpha1,l9_54);
l9_64=texture2D(sc_OITDepthLow1,l9_54);
l9_63=texture2D(sc_OITDepthHigh1,l9_54);
}
else
{
l9_65=l9_62;
...
vec4 l9_80=texture2D(sc_OITFilteredDepthBoundsTexture,l9_54);
vec2 l9_81=l9_80.xy;
int l9_82;
#if (sc_SkinBonesCount>0)
{
