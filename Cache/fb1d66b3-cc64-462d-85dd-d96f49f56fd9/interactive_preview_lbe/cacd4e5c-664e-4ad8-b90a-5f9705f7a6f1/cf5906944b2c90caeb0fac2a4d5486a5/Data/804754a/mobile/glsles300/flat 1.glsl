...
//texture texture2DArray baseTexArrSC 2:27:2:17
//texture texture2DArray intensityTextureArrSC 2:28:2:18
//texture texture2DArray sc_ScreenTextureArrSC 2:32:2:24
//SG_REFLECTION_END
...
#if (baseTexLayout==2)
{
l9_2=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_2=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_22=sc_readFragData0_Platform();
vec4 l9_23;
...
#endif
vec3 l9_30=mix(l9_28.xyz,definedBlend(l9_28.xyz,l9_5.xyz).xyz,vec3(l9_4));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_32=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_4)),l9_4);
}
#else
{
vec4 l9_33;
...
#endif
l9_33=vec4(l9_5.xyz*l9_34,l9_34);
}
#else
{
l9_33=l9_5;
...
#endif
vec4 l9_35=outputMotionVectorsIfNeeded(varPos,max(l9_6,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_38=sc_ScreenCoordsGlobalToView(l9_0);
...
mediump vec4 l9_77=texture(sc_OITFilteredDepthBoundsTexture,l9_51);
vec2 l9_78=l9_77.xy;
int l9_79;
#if (sc_SkinBonesCount>0)
{
